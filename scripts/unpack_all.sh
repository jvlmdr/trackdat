...
VOT_YEAR=2013 bash "${scripts}/unpack_vot.sh" "${dl}/vot2013" "${data}/vot2013"
VOT_YEAR=2014 bash "${scripts}/unpack_vot.sh" "${dl}/vot2014" "${data}/vot2014"
VOT_YEAR=2015 bash "${scripts}/unpack_vot.sh" "${dl}/vot2015" "${data}/vot2015"
VOT_YEAR=2016 bash "${scripts}/unpack_vot.sh" "${dl}/vot2016" "${data}/vot2016"
VOT_YEAR=2017 bash "${scripts}/unpack_vot.sh" "${dl}/vot2017" "${data}/vot2017"
